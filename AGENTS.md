...
**Description:** Self-hosted MCP gateway for VPS with dashboard, API keys, and 51 granular tools. Allows Claude Code, Cursor, and other MCP clients to remotely manage servers via Streamable HTTP transport.
